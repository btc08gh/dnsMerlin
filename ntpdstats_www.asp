...
var $j=jQuery.noConflict(),arraysortlistlines=[],sortname="Time",sortdir="desc",maxNoCharts=18,currentNoCharts=0,ShowLines=GetCookie("ShowLines","string"),ShowFill=GetCookie("ShowFill","string"),DragZoom=!0,ChartPan=!1;Chart.defaults.global.defaultFontColor="#CCC",Chart.Tooltip.positioners.cursor=function(t,e){return e};var dataintervallist=["raw","hour","day"],metriclist=["Offset","Drift"],measureunitlist=["ms","ppm"],chartlist=["daily","weekly","monthly"],timeunitlist=["hour","day","day"],intervallist=[24,7,30],bordercolourlist=["#fc8500","#ffffff"],backgroundcolourlist=["rgba(252,133,0,0.5)","rgba(255,255,255,0.5)"];function keyHandler(t){82==t.keyCode?($j(document).off("keydown"),ResetZoom()):68==t.keyCode?($j(document).off("keydown"),ToggleDragZoom(document.form.btnDragZoom)):70==t.keyCode?($j(document).off("keydown"),ToggleFill()):76==t.keyCode&&($j(document).off("keydown"),ToggleLines())}function Draw_Chart_NoData(t,e){document.getElementById("divLineChart_"+t).width="730",document.getElementById("divLineChart_"+t).height="500",document.getElementById("divLineChart_"+t).style.width="730px",document.getElementById("divLineChart_"+t).style.height="500px";var a=document.getElementById("divLineChart_"+t).getContext("2d");a.save(),a.textAlign="center",a.textBaseline="middle",a.font="normal normal bolder 48px Arial",a.fillStyle="white",a.fillText(e,365,250),a.restore()}function Draw_Chart(t,e,a,i,r){var o=getChartPeriod($j("#"+t+"_Period option:selected").val()),n=getChartInterval($j("#"+t+"_Interval option:selected").val()),s=timeunitlist[$j("#"+t+"_Period option:selected").val()],l=intervallist[$j("#"+t+"_Period option:selected").val()],d=moment(),m=null,c=moment().subtract(l,s+"s"),u="line",f=window[t+"_"+n+"_"+o];if(null!=f)if(0!=f.length){var p=f.map((function(t){return t.Metric})),h=f.map((function(t){return{x:t.Time,y:t.Value}})),g=window["LineChart_"+t],y=getTimeFormat($j("#Time_Format option:selected").val(),"axis"),b=getTimeFormat($j("#Time_Format option:selected").val(),"tooltip");"day"==n&&(u="bar",m=moment().endOf("day").subtract(9,"hours"),c=moment().startOf("day").subtract(l-1,s+"s").subtract(12,"hours"),d=m),"daily"==o&&"day"==n&&(s="day",l=1,m=moment().endOf("day").subtract(9,"hours"),c=moment().startOf("day").subtract(12,"hours"),d=m),factor=0,"hour"==s?factor=36e5:"day"==s&&(factor=864e5),null!=g&&g.destroy();var v=document.getElementById("divLineChart_"+t).getContext("2d"),_={segmentShowStroke:!1,segmentStrokeColor:"#000",animationEasing:"easeOutQuart",animationSteps:100,maintainAspectRatio:!1,animateScale:!0,hover:{mode:"point"},legend:{display:!1,position:"bottom",onClick:null},title:{display:!0,text:e},tooltips:{callbacks:{title:function(t,e){return"day"==n?moment(t[0].xLabel,"X").format("YYYY-MM-DD"):moment(t[0].xLabel,"X").format(b)},label:function(t,e){return round(e.datasets[t.datasetIndex].data[t.index].y,3).toFixed(3)+" "+a}},mode:"point",position:"cursor",intersect:!0},scales:{xAxes:[{type:"time",gridLines:{display:!0,color:"#282828"},ticks:{min:c,max:m,display:!0},time:{parser:"X",unit:s,stepSize:1,displayFormats:y}}],yAxes:[{gridLines:{display:!1,color:"#282828"},scaleLabel:{display:!1,labelString:a},ticks:{display:!0,callback:function(t,e,i){return round(t,3).toFixed(3)+" "+a}}}]},plugins:{zoom:{pan:{enabled:ChartPan,mode:"xy",rangeMin:{x:c,y:getLimit(h,"y","min",!1)-.1*Math.sqrt(Math.pow(getLimit(h,"y","min",!1),2))},rangeMax:{x:d,y:getLimit(h,"y","max",!1)+.1*getLimit(h,"y","max",!1)}},zoom:{enabled:!0,drag:DragZoom,mode:"xy",rangeMin:{x:c,y:getLimit(h,"y","min",!1)-.1*Math.sqrt(Math.pow(getLimit(h,"y","min",!1),2))},rangeMax:{x:d,y:getLimit(h,"y","max",!1)+.1*getLimit(h,"y","max",!1)},speed:.1}}},annotation:{drawTime:"afterDatasetsDraw",annotations:[{type:ShowLines,mode:"horizontal",scaleID:"y-axis-0",value:getAverage(h),borderColor:i,borderWidth:1,borderDash:[5,5],label:{backgroundColor:"rgba(0,0,0,0.3)",fontFamily:"sans-serif",fontSize:10,fontStyle:"bold",fontColor:"#fff",xPadding:6,yPadding:6,cornerRadius:6,position:"center",enabled:!0,xAdjust:0,yAdjust:0,content:"Avg="+round(getAverage(h),3).toFixed(3)+a}},{type:ShowLines,mode:"horizontal",scaleID:"y-axis-0",value:getLimit(h,"y","max",!0),borderColor:i,borderWidth:1,borderDash:[5,5],label:{backgroundColor:"rgba(0,0,0,0.3)",fontFamily:"sans-serif",fontSize:10,fontStyle:"bold",fontColor:"#fff",xPadding:6,yPadding:6,cornerRadius:6,position:"right",enabled:!0,xAdjust:15,yAdjust:0,content:"Max="+round(getLimit(h,"y","max",!0),3).toFixed(3)+a}},{type:ShowLines,mode:"horizontal",scaleID:"y-axis-0",value:getLimit(h,"y","min",!0),borderColor:i,borderWidth:1,borderDash:[5,5],label:{backgroundColor:"rgba(0,0,0,0.3)",fontFamily:"sans-serif",fontSize:10,fontStyle:"bold",fontColor:"#fff",xPadding:6,yPadding:6,cornerRadius:6,position:"left",enabled:!0,xAdjust:15,yAdjust:0,content:"Min="+round(getLimit(h,"y","min",!0),3).toFixed(3)+a}}]}};g=new Chart(v,{type:u,data:{labels:p,datasets:[{data:h,borderWidth:1,pointRadius:1,lineTension:0,fill:ShowFill,backgroundColor:r,borderColor:i}]},options:_}),window["LineChart_"+t]=g}else Draw_Chart_NoData(t,"No data to display");else Draw_Chart_NoData(t,"No data to display")}function getLimit(t,e,a,i){var r,o=0;return r="x"==e?t.map((function(t){return t.x})):t.map((function(t){return t.y})),o="max"==a?Math.max.apply(Math,r):Math.min.apply(Math,r),"max"==a&&0==o&&0==i&&(o=1),o}function getAverage(t){for(var e=0,a=0;a<t.length;a++)e+=1*t[a].y;return e/t.length}function round(t,e){return Number(Math.round(t+"e"+e)+"e-"+e)}function ToggleLines(){""==ShowLines?(ShowLines="line",SetCookie("ShowLines","line")):(ShowLines="",SetCookie("ShowLines",""));for(var t=0;t<metriclist.length;t++){for(var e=0;e<3;e++)window["LineChart_"+metriclist[t]].options.annotation.annotations[e].type=ShowLines;window["LineChart_"+metriclist[t]].update()}}function ToggleFill(){"false"==ShowFill?(ShowFill="origin",SetCookie("ShowFill","origin")):(ShowFill="false",SetCookie("ShowFill","false"));for(var t=0;t<metriclist.length;t++)window["LineChart_"+metriclist[t]].data.datasets[0].fill=ShowFill,window["LineChart_"+metriclist[t]].update()}function RedrawAllCharts(){for(var t=0;t<metriclist.length;t++){Draw_Chart_NoData(metriclist[t],"Data loading...");for(var e=0;e<chartlist.length;e++)for(var a=0;a<dataintervallist.length;a++)d3.csv("/ext/ntpmerlin/csv/"+metriclist[t]+"_"+dataintervallist[a]+"_"+chartlist[e]+".htm").then(SetGlobalDataset.bind(null,metriclist[t]+"_"+dataintervallist[a]+"_"+chartlist[e]))}}function SetGlobalDataset(t,e){if(window[t]=e,++currentNoCharts==maxNoCharts){document.getElementById("ntpupdate_text").innerHTML="",showhide("imgNTPUpdate",!1),showhide("ntpupdate_text",!1),showhide("btnUpdateStats",!0);for(var a=0;a<metriclist.length;a++)$j("#"+metriclist[a]+"_Interval").val(GetCookie(metriclist[a]+"_Interval","number")),changePeriod(document.getElementById(metriclist[a]+"_Interval")),$j("#"+metriclist[a]+"_Period").val(GetCookie(metriclist[a]+"_Period","number")),Draw_Chart(metriclist[a],metriclist[a],measureunitlist[a],bordercolourlist[a],backgroundcolourlist[a]);AddEventHandlers(),get_lastx_file()}}function getTimeFormat(t,e){var a;return"axis"==e?0==t?a={millisecond:"HH:mm:ss.SSS",second:"HH:mm:ss",minute:"HH:mm",hour:"HH:mm"}:1==t&&(a={millisecond:"h:mm:ss.SSS A",second:"h:mm:ss A",minute:"h:mm A",hour:"h A"}):"tooltip"==e&&(0==t?a="YYYY-MM-DD HH:mm:ss":1==t&&(a="YYYY-MM-DD h:mm:ss A")),a}function GetCookie(t,e){return null!=cookie.get("ntp_"+t)?cookie.get("ntp_"+t):"string"==e?"":"number"==e?0:void 0}function SetCookie(t,e){cookie.set("ntp_"+t,e,3650)}function AddEventHandlers(){$j(".collapsible-jquery").off("click").on("click",(function(){$j(this).siblings().toggle("fast",(function(){"none"==$j(this).css("display")?SetCookie($j(this).siblings()[0].id,"collapsed"):SetCookie($j(this).siblings()[0].id,"expanded")}))})),$j(".collapsible-jquery").each((function(t,e){"collapsed"==GetCookie($j(this)[0].id,"string")?$j(this).siblings().toggle(!1):$j(this).siblings().toggle(!0)}))}function SetCurrentPage(){document.form.next_page.value=window.location.pathname.substring(1),document.form.current_page.value=window.location.pathname.substring(1)}function ErrorCSVExport(){document.getElementById("aExport").href="javascript:alert('Error exporting CSV,please refresh the page and try again')"}function ParseCSVExport(t){for(var e="Timestamp,Offset,Frequency,Sys_Jitter,Clk_Jitter,Clk_Wander,Rootdisp\n",a=0;a<t.length;a++){var i=t[a].Timestamp+","+t[a].Offset+","+t[a].Frequency+","+t[a].Sys_Jitter+","+t[a].Clk_Jitter+","+t[a].Clk_Wander+","+t[a].Rootdisp;e+=a<t.length-1?i+"\n":i}document.getElementById("aExport").href="data:text/csv;charset=utf-8,"+encodeURIComponent(e)}function initial(){SetCurrentPage(),LoadCustomSettings(),show_menu(),$j("#sortTableContainer").empty(),$j("#sortTableContainer").append(BuildLastXTableNoData()),get_conf_file(),d3.csv("/ext/ntpmerlin/csv/CompleteResults.htm").then((function(t){ParseCSVExport(t)})).catch((function(){ErrorCSVExport()})),$j("#Time_Format").val(GetCookie("Time_Format","number")),ScriptUpdateLayout(),get_statstitle_file(),RedrawAllCharts()}function ScriptUpdateLayout(){var t=GetVersionNumber("local"),e=GetVersionNumber("server");$j("#ntpmerlin_version_local").text(t),t!=e&&"N/A"!=e&&($j("#ntpmerlin_version_server").text("Updated version available: "+e),showhide("btnChkUpdate",!1),showhide("ntpmerlin_version_server",!0),showhide("btnDoUpdate",!0))}function reload(){location.reload(!0)}function Validate_Number_Setting(t,e,a){t.name;var i=1*t.value;return i>e||i<a?($j(t).addClass("invalid"),!1):($j(t).removeClass("invalid"),!0)}function Format_Number_Setting(t){t.name;var e=1*t.value;return 0!=t.value.length&&NaN!=e&&(t.value=parseInt(t.value),!0)}function Validate_All(){var t=!1;return Validate_Number_Setting(document.form.ntpmerlin_lastxresults,100,10)||(t=!0),Validate_Number_Setting(document.form.ntpmerlin_daystokeep,365,30)||(t=!0),!t||(alert("Validation for some fields failed. Please correct invalid values and try again."),!1)}function getChartPeriod(t){var e="daily";return 0==t?e="daily":1==t?e="weekly":2==t&&(e="monthly"),e}function getChartInterval(t){var e="raw";return 0==t?e="raw":1==t?e="hour":2==t&&(e="day"),e}function changePeriod(t){value=1*t.value,name=t.id.substring(0,t.id.indexOf("_")),2==value?$j('select[id="'+name+'_Period"] option:contains(24)').text("Today"):$j('select[id="'+name+'_Period"] option:contains("Today")').text("Last 24 hours")}function ResetZoom(){for(var t=0;t<metriclist.length;t++){var e=window["LineChart_"+metriclist[t]];null!=e&&e.resetZoom()}}function ToggleDragZoom(t){var e=!0,a=!1,i="";-1!=t.value.indexOf("On")?(e=!1,a=!0,DragZoom=!1,ChartPan=!0,i="Drag Zoom Off"):(e=!0,a=!1,DragZoom=!0,ChartPan=!1,i="Drag Zoom On");for(var r=0;r<metriclist.length;r++){var o=window["LineChart_"+metriclist[r]];null!=o&&(o.options.plugins.zoom.zoom.drag=e,o.options.plugins.zoom.pan.enabled=a,t.value=i,o.update())}}function update_status(){$j.ajax({url:"/ext/ntpmerlin/detect_update.js",dataType:"script",error:function(t){setTimeout(update_status,1e3)},success:function(){"InProgress"==updatestatus?setTimeout(update_status,1e3):(document.getElementById("imgChkUpdate").style.display="none",showhide("ntpmerlin_version_server",!0),"None"!=updatestatus?($j("#ntpmerlin_version_server").text("Updated version available: "+updatestatus),showhide("btnChkUpdate",!1),showhide("btnDoUpdate",!0)):($j("#ntpmerlin_version_server").text("No update available"),showhide("btnChkUpdate",!0),showhide("btnDoUpdate",!1)))}})}function CheckUpdate(){showhide("btnChkUpdate",!1),document.formScriptActions.action_script.value="start_ntpmerlincheckupdate",document.formScriptActions.submit(),document.getElementById("imgChkUpdate").style.display="",setTimeout(update_status,2e3)}function DoUpdate(){document.form.action_script.value="start_ntpmerlindoupdate",document.form.action_wait.value=10,showLoading(),document.form.submit()}function update_ntpstats(){$j.ajax({url:"/ext/ntpmerlin/detect_ntpmerlin.js",dataType:"script",error:function(t){setTimeout(update_ntpstats,1e3)},success:function(){"InProgress"==ntpstatus?setTimeout(update_ntpstats,1e3):"GenerateCSV"==ntpstatus?(document.getElementById("ntpupdate_text").innerHTML="Retrieving data for charts...",setTimeout(update_ntpstats,1e3)):"Done"==ntpstatus&&(document.getElementById("ntpupdate_text").innerHTML="Refreshing charts...",PostNTPUpdate())}})}function PostNTPUpdate(){currentNoCharts=0,$j("#Time_Format").val(GetCookie("Time_Format","number")),get_statstitle_file(),setTimeout(RedrawAllCharts,3e3)}function UpdateStats(){showhide("btnUpdateStats",!1),document.formScriptActions.action_script.value="start_ntpmerlin",document.formScriptActions.submit(),document.getElementById("ntpupdate_text").innerHTML="Retrieving timeserver stats",showhide("imgNTPUpdate",!0),showhide("ntpupdate_text",!0),setTimeout(update_ntpstats,5e3)}function SaveConfig(){document.getElementById("amng_custom").value=JSON.stringify($j("form").serializeObject()),document.form.action_script.value="start_ntpmerlinconfig",document.form.action_wait.value=10,showLoading(),document.form.submit()}function GetVersionNumber(t){var e;return"local"==t?e=custom_settings.ntpmerlin_version_local:"server"==t&&(e=custom_settings.ntpmerlin_version_server),void 0===e||null==e?"N/A":e}function get_conf_file(){$j.ajax({url:"/ext/ntpmerlin/config.htm",dataType:"text",error:function(t){setTimeout(get_conf_file,1e3)},success:function(data){var configdata=data.split("\n");configdata=configdata.filter(Boolean);for(var i=0;i<configdata.length;i++)eval("document.form.ntpmerlin_"+configdata[i].split("=")[0].toLowerCase()).value=configdata[i].split("=")[1].replace(/(\r\n|\n|\r)/gm,"")}})}$j(document).keydown((function(t){keyHandler(t)})),$j(document).keyup((function(t){$j(document).keydown((function(t){keyHandler(t)}))})),$j.fn.serializeObject=function(){var t=custom_settings,e=this.serializeArray();return $j.each(e,(function(){void 0!==t[this.name]&&-1!=this.name.indexOf("ntpmerlin")&&-1==this.name.indexOf("version")?(t[this.name].push||(t[this.name]=[t[this.name]]),t[this.name].push(this.value||"")):-1!=this.name.indexOf("ntpmerlin")&&-1==this.name.indexOf("version")&&(t[this.name]=this.value||"")})),t};let databaseResetDone=0;function get_statstitle_file(){$j.ajax({url:"/ext/ntpmerlin/ntpstatstext.js",dataType:"script",error:function(t){setTimeout(get_statstitle_file,2e3)},success:function(){SetNTPDStatsTitle(),1===databaseResetDone&&(currentNoCharts=0,$j("#Time_Format").val(GetCookie("Time_Format","number")),RedrawAllCharts(),databaseResetDone+=1),setTimeout(get_statstitle_file,4e3)}})}function get_lastx_file(){$j.ajax({url:"/ext/ntpmerlin/lastx.htm",dataType:"text",error:function(t){setTimeout(get_lastx_file,1e3)},success:function(t){ParseLastXData(t)}})}function ParseLastXData(t){var e=t.split("\n");e=e.filter(Boolean),arraysortlistlines=[];for(var a=0;a<e.length;a++)try{var i=e[a].split(","),r=new Object;r.Time=moment.unix(i[0].trim()).format("YYYY-MM-DD HH:mm:ss"),r.Offset=i[1].trim(),r.Drift=i[2].trim(),arraysortlistlines.push(r)}catch{}SortTable(sortname+" "+sortdir.replace("desc","↑").replace("asc","↓").trim())}function SortTable(sorttext){sortname=sorttext.replace("↑","").replace("↓","").trim();var sorttype="number",sortfield=sortname;switch(sortname){case"Time":sorttype="date";break}"string"==sorttype?-1==sorttext.indexOf("↓")&&-1==sorttext.indexOf("↑")||-1!=sorttext.indexOf("↓")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => (a."+sortfield+" > b."+sortfield+") ? 1 : ((b."+sortfield+" > a."+sortfield+") ? -1 : 0));"),sortdir="asc"):(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => (a."+sortfield+" < b."+sortfield+") ? 1 : ((b."+sortfield+" < a."+sortfield+") ? -1 : 0));"),sortdir="desc"):"number"==sorttype?-1==sorttext.indexOf("↓")&&-1==sorttext.indexOf("↑")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => parseFloat(a."+sortfield+'.replace("m","000")) - parseFloat(b.'+sortfield+'.replace("m","000")));'),sortdir="asc"):-1!=sorttext.indexOf("↓")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => parseFloat(a."+sortfield+'.replace("m","000")) - parseFloat(b.'+sortfield+'.replace("m","000"))); '),sortdir="asc"):(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => parseFloat(b."+sortfield+'.replace("m","000")) - parseFloat(a.'+sortfield+'.replace("m","000")));'),sortdir="desc"):"date"==sorttype&&(-1==sorttext.indexOf("↓")&&-1==sorttext.indexOf("↑")||-1!=sorttext.indexOf("↓")?(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => new Date(a."+sortfield+") - new Date(b."+sortfield+"));"),sortdir="asc"):(eval("arraysortlistlines = arraysortlistlines.sort((a,b) => new Date(b."+sortfield+") - new Date(a."+sortfield+"));"),sortdir="desc")),$j("#sortTableContainer").empty(),$j("#sortTableContainer").append(BuildLastXTable()),$j(".sortable").each((function(t,e){e.innerHTML.replace(/ \(.*\)/,"").replace(" ","")==sortname&&(e.innerHTML="asc"==sortdir?e.innerHTML+" ↑":e.innerHTML+" ↓")}))}function BuildLastXTableNoData(){return"<tr>",'<td colspan="3" class="nodata">',"Data loading...","</td>","</tr>","</table>",'<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="sortTable"><tr><td colspan="3" class="nodata">Data loading...</td></tr></table>'}function BuildLastXTable(){var t='<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="sortTable">';t+='<col style="width:150px;">',t+='<col style="width:280px;">',t+='<col style="width:280px;">',t+='<thead class="sortTableHeader">',t+="<tr>",t+='<th class="sortable" onclick="SortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Time</th>',t+='<th class="sortable" onclick="SortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Offset (ms)</th>',t+='<th class="sortable" onclick="SortTable(this.innerHTML.replace(/ \\(.*\\)/,\'\'))">Drift (ppm)</th>',t+="</tr>",t+="</thead>",t+='<tbody class="sortTableContent">';for(var e=0;e<arraysortlistlines.length;e++)t+='<tr class="sortRow">',t+="<td>"+arraysortlistlines[e].Time+"</td>",t+="<td>"+arraysortlistlines[e].Offset+"</td>",t+="<td>"+arraysortlistlines[e].Drift+"</td>",t+="</tr>";return t+="</tbody>",t+="</table>"}function changeChart(t){value=1*t.value,name=t.id.substring(0,t.id.indexOf("_")),SetCookie(t.id,value),"Offset"==name?Draw_Chart("Offset",metriclist[0],measureunitlist[0],bordercolourlist[0],backgroundcolourlist[0]):"Drift"==name&&Draw_Chart("Drift",metriclist[1],measureunitlist[1],bordercolourlist[1],backgroundcolourlist[1])}function changeAllCharts(t){value=1*t.value,name=t.id.substring(0,t.id.indexOf("_")),SetCookie(t.id,value);for(var e=0;e<metriclist.length;e++)Draw_Chart(metriclist[e],metriclist[e],measureunitlist[e],bordercolourlist[e],backgroundcolourlist[e])}
